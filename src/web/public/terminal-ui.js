...
(function (global) {
  ...
  const CODEMAN_XTERM_THEMES = {
    ...
    // Light skin — GitHub Light ANSI on a soft off-white. ANSI 'white' maps to a
    // mid-grey and 'brightWhite' to near-black so text stays visible on a light bg.
    light: { background: '#fbfcfd', foreground: '#1f2328', cursor: '#0969da', cursorAccent: '#fbfcfd', selection: 'rgba(9,105,218,0.20)', black: '#24292e', red: '#d73a49', green: '#22863a', yellow: '#b08800', blue: '#0969da', magenta: '#6639ba', cyan: '#1b7c83', white: '#6a737d', brightBlack: '#959da5', brightRed: '#cb2431', brightGreen: '#28a745', brightYellow: '#b08800', brightBlue: '#2188ff', brightMagenta: '#8a63d2', brightCyan: '#3192aa', brightWhite: '#24292e' },
  };
